...
function changeVal (obj){
	var snakeProp = [];
	snakeProp.push(obj)
	console.log(snakeProp)
	for(var i = 0; i<snakeProp.length;i++){
		var value = snakeProp[i]
		console.log(value)
...
var firstHero = heroes.splice(heroes[0],1)
console.log(firstHero)
// add 'spongebob' to the start of the array
heroes.splice(heroes[0],0,'spongebob')
console.log(heroes)
...
console.log(addItem([3,4,3,2,1],'happy'))
...
console.log(removeItem(['h','e','l','l','o'],'l'))
...
console.log(obj.justin)
console.log(getValueOfProperty(obj,'justin'))
